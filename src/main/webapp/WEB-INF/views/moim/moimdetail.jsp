        ...
        <div class="clubdetail">
            <div class="category">
                <div class="image-wrapper">
                    <%--<img src="${categoryImg}" alt="카테고리이미지"/>--%>
                </div>
            </div>
            <div class="clubdetail-moim">
                ...
                <ul class="clubdetail-area">
                    ...
                    <li class="clubdetail-membercount" name="moimNCount">멤버&nbsp;<%--<%=moimAllMemvlist.size() %>--%>
                    </li>
			  ...
			  height: 30px;">
                    ...
                    <c:if test="${dto.member.memberId eq null}">
                        ...
                        <li>
                            <button type="button" class="classManageBtn" onclick="memberManage_class()">클래스회원관리</button>
                        </li>
...
<%--                                </li>--%>
<%--                                <li class="ico cost" name=""><%=moimbean.getClassprice() %>--%>
<%--                                </li>--%>
<%--                            </ul>--%>
<%--                        </li>--%>
<%--                        <li class="btn">--%>
...
<%--                    <%} else if (manngerBean.getMemberId().equals(memberId)) {%>--%>
                    <li>
                        <button type="button" class="moimEditorBtn" onclick="moimUpdate_moim()">내모임관리</button>
                    </li>
                    <li>
                        <button type="button" class="memberManageBtn" onclick="memberManage_moim()">모임회원관리</button>
                    </li>
